      ...
      <section style={{ background: 'var(--cream)', padding: '64px 0' }}>
        <div className="container" style={{ maxWidth: 800 }}>
          {[
            ...
            { title: 'How We Use Your Information', body: 'We use the information we collect to respond to your inquiries, send updates about Liftêd<TM/>, manage our founding community pipeline, and improve our website. We use HighLevel CRM to manage contact records and follow-up communications.' },
            { title: 'SMS and Email Communications', body: 'By submitting a form on this website, you consent to receive email and SMS communications from Liftêd<TM/> and ARMS Reach Digital Agency. You may opt out at any time by replying STOP to any SMS or clicking unsubscribe in any email.' },
