  ...
  return (
    <div>
      ...
      {[
        ...
        { title: 'Front-and-Back Message System', content: 'Every Liftêd™ garment works in two directions. The back carries a message for the observer — an unexpected encouragement for the person standing behind them. The front message varies by collection: Core, Athlete, Youth, and Collaboration fronts face outward as traditional brand statements. The Pick-Me-Up Collection is different — its front messages are written in first person and intentionally printed upside down so they read correctly when the wearer looks down at their own shirt. The message is for them first. One garment. Two people lifted.' },
      ].map(s => (
