...
const collections = [
  ...
  { id: 'pickup', name: 'Pick-Me-Up Collection', color: '#4A7FB5', icon: '↑', tagline: 'First-person messages written for the wearer, shown upside down.', desc: 'The Pick-Me-Up Collection was created for the person wearing it. Each front message is written in first person and shown upside down so it reads correctly when the wearer looks down. The back continues the encouragement by sharing a message with the person standing behind them.', messages: ['I Matter Here.', "My Story Isn't Over.", 'I Can Take It One Day at a Time.', 'Better Days Are Ahead for Me.', "I'm Doing Better Than I Think."], products: 'Message tees · Hoodies · Sweatshirts' },
