      ...
      <section style={{ background: 'var(--cream)', padding: '64px 0' }}>
        <div className="container" style={{ maxWidth: 800 }}>
          {[
            ...
            { title: 'Pre-Revenue Status', body: 'Liftêd<TM/> is a pre-revenue brand currently in product development. Product images, designs, and descriptions shown on this website may be concept mockups. Final products will be confirmed after sample validation.' },
            ...
            { title: 'Intellectual Property', body: 'Liftêd<TM/>, the Liftêd<TM/> logo, and all associated brand elements are trademarks of ARMS Reach Digital Agency. All content on this website is protected by copyright. You may not reproduce, distribute, or create derivative works without written permission.' },
            ...
            { title: 'Limitation of Liability', body: 'ARMS Reach Digital Agency and Liftêd<TM/> shall not be liable for any indirect, incidental, or consequential damages arising from your use of this website.' },
