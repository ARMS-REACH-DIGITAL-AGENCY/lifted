 ...
 * Does NOT display confidential investor information.
 * Form submits to /api/investor-access — no automatic account creation.
 */
...
export default function InvestorAccess() {
  ...
  return (
    <div style={{ background: 'var(--warm-cream)', minHeight: '100vh', paddingTop: 80 }}>
      {/* noindex meta is handled in index.html via react-helmet or manually — see README */}
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px 80px' }}>
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            {status === 'error' && (
              <div style={{ background: '#FEE2E2', border: '1px solid #EF4444', padding: '12px 16px', marginBottom: 16, fontFamily: 'var(--font-body)', fontSize: 13, color: '#B91C1C' }}>{errorMsg}</div>
            )}
            ...
            <div style={{ marginTop: 20, padding: '16px', background: 'rgba(41,42,40,0.06)', borderLeft: '3px solid var(--burnt-orange)', fontFamily: 'var(--font-body)', fontSize: 12, color: 'var(--muted-olive)', lineHeight: 1.7 }}>
              Information provided through this website is for informational purposes only and does not constitute an offer to sell or a solicitation to purchase securities. Any potential opportunity will be presented only through appropriate documentation and applicable legal procedures.
            </div>
