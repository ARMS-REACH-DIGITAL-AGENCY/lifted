  ...
  return (
    <div style={{ background: 'var(--warm-cream)', minHeight: '100vh' }}>
     ...
     {/* ── Hero ── */}
      <PageHero
        eyebrow="OUR STORY"
        heading={<>An Id<span style={{ color: 'var(--sand)' }}>ê</span>a 15 Years<br />in the Making.</>}
        description="Liftêd™ did not begin in a boardroom or branding session."
        bgImage="/brand/story/origin-team-edition-shirt.jpg"
