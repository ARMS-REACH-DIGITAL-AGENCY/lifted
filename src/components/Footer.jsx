      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 40, marginBottom: 40 }}>
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 11, fontStyle: 'italic', color: 'rgba(247,244,236,0.35)' }}>The World Needs More Liftêd<TM/>.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 13, lineHeight: 1.65, marginBottom: 18 }}>Be part of the founding community. Help bring Liftêd<TM/> to market.</p>
        ...
        <div style={{ borderTop: '1px solid rgba(247,244,236,0.1)', paddingTop: 20, display: 'flex', flexWrap: 'wrap', gap: 14, justifyContent: 'space-between', alignItems: 'center' }}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 12 }}>© {year} Liftêd<TM/>. All rights reserved. Liftêd<TM/> is a trademark of ARMS Reach Digital Agency.</p>
